...
Real Shawarma is roasted on a vertical spit (Doner) for hours. At home, we achieve the same **Texture Contrast** (tender meat + crispy charred bits) by using a high-temperature oven roast followed by a quick pan-sear. The cinnamon and turmeric provide that unmistakable warm, Middle Eastern aroma.

## Directions

1.  **Marinate:** Whisk the oil, lemon juice, and all spices. Toss with the chicken thighs. Marinate for at least 4 hours (ideally overnight).
